...
<PieChart width={200} height={200} >
	<Pie data={setData} labelLine={false} label={renderCustomizedLabel(setData)} outerRadius='100%' fill={colors.statisticChart.piBorderColor /*'#8884d8'*/} dataKey="counter" >
...
return ( <text x={x} y={y} fill="white" textAnchor={x > cx ? 'start' : 'end'} dominantBaseline="central"> {`${percent> 0.1 ? Number(data[index].answer) + 1 : ""}`} </text> ); 
};
